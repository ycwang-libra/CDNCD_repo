...
def get_multicrop_transform(dataset, mean, std):
    if dataset in ["ImageNet", "DomainNet", "OfficeHome"]:
        return T.Compose(
            [
...
def get_transforms(args, mode, dataset, multicrop=False, num_large_crops=2, num_small_crops=2):
    ...
    if mode == "unsupervised":
        ...
        if multicrop:
            ...
            transforms += [multicrop_transform] * num_small_crops # in discover stage it will be [transform] [transform] [multicrop_transform] [multicrop_transform]
